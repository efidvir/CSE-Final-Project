...
# Title: Top Block Iq2
# Generated: Thu Aug 27 11:41:27 2020
##################################################
...
class top_block_iq2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_CONST_WAVE, 1, 1, 0)
        ...
        self.connect((self.blocks_complex_to_magphase_0, 1), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.blocks_complex_to_magphase_0, 0))
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_moving_average_xx_0, 0))
...
def main(top_block_cls=top_block_iq2, options=None):
